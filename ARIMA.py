...
plt.plot(test_var , label="Actual")
plt.plot(yhat.variance.values[-1,:], color='red', label="ARCH")
...
yhat = model_fit.forecast(horizon=len(test))
plt.plot(test_var, label="Actual")
plt.plot(yhat.variance.values[-1,:], color='red', label="GARCH")
...
plt.plot(series2)
plt.title("Price VS delivery_end_date")
plt.xlabel("T (delivery_end_date)")
plt.ylabel("Price")
plt.show()
